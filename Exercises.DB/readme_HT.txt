...
H HT_HashStatistics εκτυπωνει τα στατιστικα που ζητηθηκαν και δουλευει μονο για αρχεια κατακερματισμου (πρεπει η open που καλειται μεσα να επιστρεφει HT_info). Αρχικα 
κανουμε αρχικοποιηση ολων των μεταβλητων που θα χρησιμοποιηθουν για τα στατιστικα. Ο πινακας chainLengths θα κραταει των αριθμο μπλοκ για καθε καδο. Για να βρουμε τα 
στατιστικα κανουμε ενα loop για ολα τα buckets. Μερικα απο αυτα μπορει να εχουν -1 στον πινακα, δηλαδη να μην εχουν ακομα μπλοκ, οποτε ενημερωνουμε το chainLengths[i]
να ειναι 0 καθως και το minRecords σε 0 (αν ο καδος εχει 0 μπλοκ, εχει και 0 εγγραφες). Αν υπαρχει μπλοκ τοτε προσθετουμε ολες τις εγγραφες του στο recordCount (που 
μετραει ολες τις εγγραφες του καδου) και συνεχιζουμε την ιδια διαδικασια για ολα τα επομενα μπλοκ οσο βρισκουμε επομενα στην αλυσιδα υπερχειλισης. Ενημερωνουμε το Sum, 
min και max και αφου περασουμε απ ολους τους καδους εκτυπωνουμε τα στατιστικα.

2)ht_main.c

Στην main εχουμε βαλλει αρκετα print, ωστε να φαινεται η ροη του προγραμματος. Κατα την δημιουργια ενος record μπαινει απευθειας στο
